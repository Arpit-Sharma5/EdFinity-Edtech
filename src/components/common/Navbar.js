...
const Navbar = () => {
  ...
  return (
    <div className='flex h-14 items-center justify-center border-b-[1px] border-b-brownred-800 shadow-brownred-500 bg-brownred-700/5'>
      ...
      <nav>
        ...
        <div className='hidden md:flex gap-x-4 items-center'>
            ...
            }
            {
                token === null && (
                    <Link to="/login">
                        <button className='border  border-brownred-900 bg-brownred-800 px-[12px] py-[8px] text-brownred-50 rounded-md'>
                            Log in
                        </button>
                    </Link>
                )

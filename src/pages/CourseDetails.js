...
const CourseDetails = () => {
  ...
  return (
    <>
        ...
        <div className='relative w-full bg-brownred-800'>
            <div className='mx-auto box-content px-4 lg:w-[1260px] 2xl:relative '>
                <div className='mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]'>
                   ...
                   <div className='z-30 my-5 flex flex-col justify-center gap-4 py-5 text-lg text-brownred-50'>
                        <p className='text-4xl font-bold text-brownred-50 sm:text-[42px]'>{courseName}</p>
                        <p className='text-brownred-200'>{description}</p>
                   ...
                   <div className='flex w-full flex-col gap-4 border-y border-y-brownred-500 py-4 lg:hidden'>
                        <p className='space-x-3 pb-4 text-3xl font-semibold text-brownred-50'>
                            Rs. {price}
                        </p>
        ...
        <div className='mx-auto box-content px-4 text-start text-brownred-50 lg:w-[1260px]'>
            <div className='mx-auto max-w-maxContentTab lg:mx-0 xl:max-w-[810px]'>
                <div className='my-8 border border-brownred-600 p-8'>
                    ...
                    <div className='py-4'>
                        {
                            courseContent.map((section) => (
                                <div key={section._id} className='overflow-hidden border border-solid border-brownred-600 bg-brownred-800 text-brownred-50 last:mb-0'>
                                    {/* Section */}
                                    ...
                                    {/* SubSections */}
                                    <div className={` ${isActive.includes(section._id) ? 'h-[88px]' : ''} relative h-0 overflow-hidden bg-brownred-900 transition-[height] duration-[0.35s] ease-[ease]`}>

        ...
        return (
            <>
                {
                    ...
                    :(
                        <>    
            <div className=" box-content bg-brownred-800 px-4">
                <div className="mx-auto flex min-h-[260px] max-w-maxContentTab flex-col justify-center gap-4 lg:max-w-maxContent ">
                <p className="text-sm text-brownred-50">{`Home / Catalog / `}
                <span className="text-yellow-25">
                    {catalogPageData?.name}
                </span></p>
                <p className="text-3xl text-brownred-50"> {catalogPageData?.name} </p>
                <p className="max-w-[870px] text-brownred-200"> {catalogPageData?.description}</p>
                </div>
            </div>
            ...
            <div >
                ...
                <div className="section_heading">Courses to get you started</div>
                    <div className="my-4 flex border-b border-b-brownred-600 text-sm">
                    <p
                    className={`px-4 py-2 ${
                      active === 1
